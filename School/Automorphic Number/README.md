<h2><a href="https://www.geeksforgeeks.org/problems/automorphic-number4721/1?page=2&category=Mathematical&difficulty=School&sortBy=submissions">Automorphic Number</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number N, check whether the&nbsp;number is Automorphic number or not.<br>A number is called Automorphic number if and only if its square ends in&nbsp; has the same last digit as the number itself. </span><br>&nbsp;</p>
